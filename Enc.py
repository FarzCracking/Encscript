...
def baner():
	os.system("clear")
	print ("%s+───────────────────────────────────────────+"%(putih))
	print ("%s[%s~%s] %sAuthor  %s: %sIKFAR-IFC"%(hijau,cyan,hijau,putih,merah,hijau))
	print ("%s+───────────────────────────────────────────+"%(putih))
	print()
	print()
...
#  sp("\033[1;96m       ║║   ║╔═╗║║╔═╗║╚╣─╝║║╚╗║║          ")
#  sp("\033[1;96m       ║║   ║║ ║║║║ ╚╝ ║║ ║╔╗╚╝║          ")
#  sp("\033[1;96m       ║║ ╔╗║║ ║║║║╔═╗ ║║ ║║╚╗║║ \033[1;97mBY IKFAR-IFC")
#  sp("\033[1;96m       ║╚═╝║║╚═╝║║╚╩═║╔╣─╗║║ ║║║")
#  sp("\033[1;96m       ╚═══╝╚═══╝╚═══╝╚══╝╚╝ ╚═╝")
#  print()
#  sp("\033[1;96m• \033[1;97mDownload Tokennya dulu")
#  sp("\033[1;96m• \033[1;97mLink \033[1;93m: \033[1;96m[ \033[1;97mhttps://www.mediafire.com/file/06itmkz0zp27rh1/Token.txt/file \033[1;96m]")
#  print()
...
note = "# Decypt lambda by IKFAR\n# HELO BANH"
def ban(): # Program Bann
    os.system("clear")
    print(cyan+" MAMPIR FB GUA DULU BANH")
    time.sleep(2)
    os.system("xdg-open /https://www.facebook.com/muhammad.firza.75055")
    time.sleep(4)
def menu():
    print()
...
def MainMenu():
   ...
   #         print(f'EE')
            ...
            ul()
        try:
            ketik ("%s{%s!%s}%s CONTOH%s :%s Namafile.py"%(putih,merah,putih,kuning,merah,hijau))
            print()
            file = eval(_input % "\x1b[1;97m{\x1b[1;93m?\x1b[1;97m} nama file yang mau di enc \x1b[1;91m:\x1b[1;92m ")
            data = open(file).read()
        except IOError:
            ketik("\n\x1b[1;97m{\x1b[1;91m!\x1b[1;97m} File Not Found!")
            time.sleep(3)
            ul()
        output = file.lower().replace('.py', '') + 'enc.py'
        if option == 16:
            SEncode(data,output)
        else:
            Encode(option,data,output)
        ketik("\n\x1b[1;97m{\x1b[1;92m✓\x1b[1;97m} Successfully Encrypted\x1b[1;93m %s" % file)
        ketik(f'{biru}THNKS YOU USING SC ME')
